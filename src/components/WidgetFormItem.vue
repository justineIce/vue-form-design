      ...
      @click.native.stop="handleSelectWidget(index)">
        ...
        <template v-if="element.type == 'text'">
            ...
            'font-size':element.options.fontSize,
             ...
             'font-weight': element.options.fontBold ? 'bold' :'normal',
             'font-style': element.options.fontItalic ? 'italic' :'normal',
             'text-decoration': element.options.fontUnderline ? (element.options.fontLineThrough ? 'line-through':'underline') :'none'
            }"
            >
        ...
        <!--按钮-->
          <template v-if="element.type == 'buttons'">
              <el-button :size="element.options.btnSize"
                         :type="element.options.type"
